...
if __name__ == '__main__':
    ...
    df = pd.read_json("/Users/ddore/Downloads/7_1976.json")
    ann_file = "/Users/ddore/Documents/ElecDeb60to20/data/annotations/text/7_1976"
    ...
    with open(f"prova.ann", "w", encoding="utf-8") as ann_file:
